...
def parser(args):
	...
	child_gene_list = [x for x in chunkify(list(gene_list), nthread)]	
...
def _child_get_permutation_fdr(args):
	"""
	...
	"""
	(unibam_file, multibam_file, child_gene_list, gene_annot, pval_cutoff, max_iter, is_stranded, correction_method,seed)=args
	random.seed(seed)
